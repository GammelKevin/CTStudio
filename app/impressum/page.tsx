...
export const metadata: Metadata = {
  title: "Impressum - CT Studio",
  description: "Impressum und rechtliche Informationen von CT Studio",
};
        ...
        <div className="space-y-8 text-muted-foreground">
          <section>
            ...
            <div className="space-y-2">
              <p className="text-foreground font-medium">CT Studio</p>
              <p>Flurweg 13</p>
              <p>94527 Aholming</p>
              <p>Deutschland</p>
            </div>
          ...
          <section>
            ...
            <div className="space-y-2">
              ...
              <p>Website: www.ct-studio.store</p>
            </div>
          </section>
